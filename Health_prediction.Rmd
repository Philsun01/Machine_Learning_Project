...
paste("The 20 predicted classifications for the test set are:", answer)
```
...
```{r MisClassification}
round(MC,3)
barplot(MC, main = "Miss Classification Rates")
print("Estimate for Out of Sample Error")
mean(MC)
```
**My estimate for out of sample error is 3%**